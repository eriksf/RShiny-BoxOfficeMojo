    ...
    sidebarLayout(
        sidebarPanel(
            ...
            p(class="text-small", "Data visualizations on movie box office rankings based on various dimensions (e.g. studios, actors, etc).  All data is derived from the IMDB Box Office Mojo website: ",
              a(href="https://www.boxofficemojo.com/", target="_blank", "https://www.boxofficemojo.com/")),
            hr(),
            ...
            tabsetPanel(id="tabset",
                        ...
                        tabPanel("Oscars",
                                 ...
                                 p(class="text-small", "Tabular searchable data display similar to that found in the original source ",
                                   a(href="https://www.boxofficemojo.com/oscar/", target="_blank", "https://www.boxofficemojo.com/oscar/")),
                        ...
                        tabPanel("Actors",
                                 ...
                                 p(class="text-small", "Tabular searchable data display similar to that found in the original source ",
                                   a(href="https://www.boxofficemojo.com/people/?view=Actor&sort=sumgross&order=DESC&p=.htm", target="_blank", "https://www.boxofficemojo.com/people/?view=Actor&sort=sumgross&order=DESC&p=.htm")),
                                 p(class="text-small", "Box office units are in million dollars ($M)."),
                                 p(class="text-small", "You can download the data with the download button above."),
                        ...
                        tabPanel("Directors",
                                 ...
                                 p(class="text-small", "Tabular searchable data display similar to that found in the original source ",
                                   a(href="https://www.boxofficemojo.com/people/?view=Director&sort=sumgross&order=DESC&p=.htm", target="_blank", "https://www.boxofficemojo.com/people/?view=Director&sort=sumgross&order=DESC&p=.htm")),
                                 p(class="text-small", "Box office units are in million dollars ($M)."),
                                 p(class="text-small", "You can download the data with the download button above."),
                        ...
                        tabPanel("Producers",
                                 ...
                                 p(class="text-small", "Tabular searchable data display similar to that found in the original source ",
                                   a(href="https://www.boxofficemojo.com/people/?view=Producer&sort=sumgross&order=DESC&p=.htm", target="_blank", "https://www.boxofficemojo.com/people/?view=Producer&sort=sumgross&order=DESC&p=.htm")),
                                 p(class="text-small", "Box office units are in million dollars ($M)."),
                                 p(class="text-small", "You can download the data with the download button above."),
                        ...
                        tabPanel("Studios",
                                 ...
                                 p(class="text-small", "Tabular searchable data display similar to that found in the original source ",
                                   a(href="https://www.boxofficemojo.com/studio/", target="_blank", "https://www.boxofficemojo.com/studio/")),
                                 p(class="text-small", "Box office units are in million dollars ($M)."),
                                 p(class="text-small", "You can download the data with the download button above."),
